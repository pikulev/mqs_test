...
ROUTES_PARAMS.registerRoute(ASSET_ROUTE_TYPE, "/app.js", `${__dirname}/../client/app.js`, "text/javascript")
ROUTES_PARAMS.registerRoute(ASSET_ROUTE_TYPE, "/routing.js", `${__dirname}/../client/routing.js`, "text/javascript")
ROUTES_PARAMS.registerRoute(ASSET_ROUTE_TYPE, "/api.js", `${__dirname}/../client/api.js`, "text/javascript")
ROUTES_PARAMS.registerRoute(ASSET_ROUTE_TYPE, "/storage.js", `${__dirname}/../client/storage.js`, "text/javascript")
ROUTES_PARAMS.registerRoute(ASSET_ROUTE_TYPE, "/transforms.js", `${__dirname}/../client/transforms.js`, "text/javascript")
ROUTES_PARAMS.registerRoute(ASSET_ROUTE_TYPE, "/utils.js", `${__dirname}/../client/utils.js`, "text/javascript")
ROUTES_PARAMS.registerRoute(ASSET_ROUTE_TYPE, "/canvas.js", `${__dirname}/../client/canvas.js`, "text/javascript")
